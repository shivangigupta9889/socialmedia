...
const CardComponent = (props) => {
  ...
  return (
    <div className=" bg-gray-100 flex justify-center items-center w-full">
      <div className=" container bg-white rounded-xl w-full shadow-lg transform transition duration-500 ">
        <div>
          ...
          <h1 className="text-2xl mt-2 ml-4 font-bold text-gray-800 cursor-pointer hover:text-gray-900 transition duration-100">{props.name}</h1>
          <p className="ml-4 mt-1 mb-2 text-gray-700 hover:underline cursor-pointer">#by Saca Tuerca</p>
        </div>
        <img className="w-full rounded-lg cursor-pointer" src="https://images.unsplash.com/photo-1525268771113-32d9e9021a97?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="" />
